...
<GenericHero
    ...
    subtitle="The Senses: Sensors & Perception 👁️"
    ...
    buttons={[
        { text: '⬅️ Back to Ep 3', style: 'secondary', href: '/Tutorials/ZeroToHero/ZeroToHero3' }
    ]}
    height="md"
    textAlign="center"
/>
...
## 🛑 Chapter 1: The Limit Switch (Digital Input)
