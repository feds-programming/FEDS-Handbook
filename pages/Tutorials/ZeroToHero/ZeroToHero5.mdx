...
<Head>
    <title>Zero to Hero Episode 5: PID Control - FEDS Handbook</title>
</Head>

<GenericHero
    title="Zero to Hero #5"
    titleColor="linear-gradient(135deg, #ec4899 0%, #db2777 100%)"
    subtitle="The Brain: PID Control 🧠"
    ...
    buttons={[
        { text: '⬅️ Back to Ep 4', style: 'secondary', href: '/Tutorials/ZeroToHero/ZeroToHero4' }
    ]}
    height="md"
    textAlign="center"
/>
...
<GenericTimeline orientation="vertical" variant="cards" items={[
    { title: "P - Proportional", description: "The Present. 'I am far away, go fast! I am close, go slow!' Main driving force.", icon: "1️⃣", date: "kP" },
    { title: "I - Integral", description: "The Past. 'I have been stuck slightly below target for a while... push harder!' Fixes steady-state error.", icon: "2️⃣", date: "kI" },
    { title: "D - Derivative", description: "The Future. 'I am approaching too fast! Slow down!' dampens motion to prevent overshoot.", icon: "3️⃣", date: "kD" }
]}
/>
...
## 💻 Chapter 2: Implementation (WPILib vs Vendor)
...
## 🚀 Chapter 3: Feedforward (The Secret Sauce)
...
In **Episode 6**, we will combine all of this to make the robot drive itself in Autonomous mode!